...
echo ""
echo "Next steps:"
echo "  1. Start services: docker compose up -d --build --force-recreate"
echo "  2. Clean build cache (saves ~3GB): docker builder prune -f"
echo "  3. Check logs: docker compose logs -f"
echo "  4. Build mobile app: cd mobile-app/code && flutter run --dart-define-from-file=configurations/.env"
echo ""
